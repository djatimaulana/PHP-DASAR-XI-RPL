...
<body>
	<div class="container-fluid bg-primary-subtle d-flex align-items-center justify-content-center" style="height:100vh" >
		<div class="card p-3 col-lg-6" style="border-radius:15px">
			...
			<h2 class="fw-bold mb-0">Jefri Nichol</h2>
			<small>Artis Aktor dan Petinju</small>
			<div class="col-12 py-3">
			<small>Tentang Saya : </small><br>
			<span class="badge rounded-pill text-bg-primary">aktor film</span>
			<span class="badge rounded-pill text-bg-danger">petinju</span>
			<span class="badge rounded-pill text-bg-warning">model</span>	
			</div>
			<div class="row">
				<div class="col-8">
